...
- <> people who converge upon truth converge upon each other <> ==prediction in the sense of predicting the outcome is not the same as predicting the probable distribution of outcome==s (the latter is about the multiverse and about counterfactual—excluding what can’t happen)
