...
- Value exists in the minds of others. **Will there be value, if others don’t exist?** Is my future-self constitute the other? #revisit 
	- **Or there will be value even without the others—because the other instances of myself exist in the multiverse?** #revisit 
		- You cannot access value scales of others, since value is subjective. Value exists without others, because value is subjective, and also because of the other instances of myself across the multiverse. The other instances of myself allows the exchange with the future-self, because other times are special cases of other universes.   
