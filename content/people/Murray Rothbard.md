...
- The action axiom and its implications:
	...
	- These scarce means must be allocated—this act of *choice* may be called *economizing* the means to serve the most desired ends. The larger the supply of means available, the more ends can be satisfied and the lower the rank of the ends that must remain unsatisfied. (pp. 5-6)
		- But even assuming infinite time (i.e., immortality), the ends must be satisfied in time. It's analogous to the difference between geometric and arithmetic processes—e.g., see the discussions from [[Nassim Taleb |Taleb]] and [[Mark Spitznagel |Spitznagel]] on path-dependent nature of compounding.
			- Related: [[3-1c2d1 Individuals or nations might possess the same values, but the ordering differs]].
...
- Since man is always acting, he must always be engaged in trying to attain the *greatest height on his value scale*. **There must *always* be room for improvement in his value scale; otherwise action would disappear**. This means that there is always open to each actor the prospect of improving his lot, of attaining a value higher than he is giving up, i.e., of *making a psychic profit*. (p. 71)
	- [[David Deutsch |Deutsch]] (or extension of his theory) would likely argue that there is objective reality out there, and with regards to the understanding of that reality there is objective improvement. But in *The Evolution of Culture*, he also emphasized how [[1-1c2a There is no escape we are and will be shaped by anti-rational memes |we cannot do away with anti-rational memes]]. 
		- [[10-2g3g Memes precede knowledge]]. #develop  
...
### 12. Property: The Appropriation of Raw Land #revisit 
...
- Value exists in the minds of others. **Will there be value, if others don’t exist?** Is my future-self constitute the other? #revisit 
	- **Or there will be value even without the others—because the other instances of myself exist in the multiverse?** #revisit 
		- You cannot access value scales of others, since value is subjective. Value exists without others, because value is subjective, and also because of the other instances of myself across the multiverse. The other instances of myself allows the exchange with the future-self, because other times are special cases of other universes. #revisit  
...
- *But how, then, can value scales and utilities be used to explain the formation of money prices, when these value scales and utilities themselves depend upon the existence of money prices?* (p. 268)
	- In short, any prior money (e.g., gold, USD, and Bitcoin) must necessarily trace its origin back to the original money, which must've had direct use-value. And because all subsequent money derived part of its value from that historical chain starting with the original money, even if the new money does not exhibit the property of direct use-value (e.g., Bitcoin), and even with the seemingly naivety of assuming some "objective use-value" (e.g., gold) which contradicts the subjective value axiom, the regression theorem still stands because the original money must've had direct, *subjective*, use-value.
		- Relate this with [[Eric Voskuil]]’s [Collectible Tautology] #revisit 
...
- “The scale of value is nothing but a constructed tool of thought. The scale of value manifests itself only in real acting; it can be discerned only from the observation of real acting. It is therefore impermissible to contrast it with real acting and to use it as a yardstick for the appraisal of real actions." – [[Ludwig von Mises]] (p. 309)
	- Value scales are ascertainable from the real actions, not vice versa. #revisit
		- Because the value scale cannot be exhausted. #revisit 
...
That a *final equilibrium* position implies the end of progress. That experimental results cannot be used to verify theories due to the non-determinacy which is inherent in each universe—and that this might be relate fallibilism with the multiverse. That because the multiverse is the general condition, and because the multiverse allows the explanation of life and mind by allowing the causality to be evoked by the mind, causation (as a concept implied in the multiverse) is sure to explain human actions. That the mathematical equations of the evenly rotating economy describe only a static situation, outside of time—in short, it disregards the multiverse. That the use of the mathematical concept of “function” is particularly inappropriate in a science of human action where the result does not simultaneously determine the cause—because humans create their own causality. That knowledge is unpredictable (viz., our “function” keeps evolving), and only that part of knowledge that can be ascertained through actions can be conjectured (viz., actions can’t reveal the whole of value scales). That *money* is usable in every line of production—saving literally can save you (especially under our assumption that labor may be specific). That only monetary income (or loss) can be measured *ex post*—never psychic income (or loss). That the cost involves what *it could’ve been otherwise*—and there is no otherwise under our assumption where all factors are specific. That the use of labor does have a cost, even under our assumption of specific labor, in accordance with the value of the leisure forgone by the laborers. That there are no “objective” or “real” costs that determine, or are co-ordinate in determining, price. That time is a critical element in production, and its analysis must pervade any theory of production. That in a world where products are all jointly owned by owners of factors, the original owners of land and labor must do their own saving—the owners of land and labor "save" real resources (i.e., *present* consumption), and not in money. That it is impossible for us to say what this saving or investment was in monetary terms because the question of leisure forgone (which constitutes the saving under the current assumption) implies time preference—and since time preference is subjective preference, it cannot be measured in monetary terms. That the capitalists are not *powerful*. That interest arises because the capitalists buy labor and land today in exchange for goods that will be sold in the future. That money, the general medium of exchange, is precisely nonspecific. That the concept of *rate* of return is necessary in order to compare different potential investments for different periods of time and involving different sums of money—because of money, the concept of rate of return can be abstracted to the ratio between present goods exchanged against future goods in general. That money's medium-ness means it can be exchanged with any other goods—*it can be otherwise*. That humans replicated themselves in money. That the *pure rate of interest* will be uniform for all periods of time and for all lines of production and will remain constant in the ERE. That capital goods per se are not productive. That the capitalists are not exploiters but intermediaries, bridging present and future demand with money—because, by definition, money is the best technology for this function. That the subjective utility of individuals—both of consumers and producers—*alone* determines how much productive energy and savings will go into producing goods (i.e., size)—both total size and specific sizes. That the economist, instead of viewing the economy from the standpoint of an individual entrepreneur, must take account of all the interrelations in the economy. That the long run, by its very nature, *never does and never can exist*—the actual market prices are the only ones that *ever* exist. That the physical reality creates life, mind, and money via the Turing principle—as such the multiverse is implied in life, mind, and money. That the “long run” of the ERE is not real at all, but a very useful theoretical construct that enables the economist to point out the direction in which the market is moving at any given time. That laborer could always enjoy leisure, and this sets a minimum supply price for labor service—the use of land, on the contrary, sacrifices no leisure. 
...
- **The concept of *rate* of return is necessary in order for him to compare different potential investments for different periods of time and involving different sums of money**. (p. 350)
	...
	- Although David Deutsch emphasized fungibility as one of the distinguishing features of money, many other goods are by definition fungible—it's the combination of money's medium-ness (viz., *it could be anything*, due to its being money) and its fungibility that makes it uniquely useful. #develop 
		- Money can be *anything* because of its salability? #revisit 
	- **Money's medium-ness means it can be exchanged with any other goods** (another sense of fungibility apart from the literal sense of how any dollar bill can substitute any other dollar bill)—***it can be otherwise***—it's analogous to a quantum system before differentiation via entanglement. #develop 
...
### Personal Questions
- **Is it fair to say that in confining itself to knowledge as can be evoked only through actions, Rothbard (and other Austrian economists) succumbs to a form of empiricism?** 
	- More precisely, Rothbard is concerned with actions because actions result in differences across the multiverse—he is concerned with *humanly ascertainable* values scales. 
...
### Personal Answers and Implications #revisit 
- What actually happens in the formation of a progressing economy: **the time-preference schedules of individuals shift downward, which is synonymous with the lowering of interest rate, with more saving, and with more investment → capital accumulation → higher real incomes → but these higher real incomes are met with lowered interest rate (or rather, the former is a result of the latter)**. #revisit 
	- It is not circular reasoning—the real income increase doesn’t cause another round of saving.
		- At the individual level: if someone's real income rises and their time preference remains the same, they’ll save more because they can now meet their present wants more easily and allocate more toward future wants.
		- At the aggregate, because the interest rate is now lower, the marginal return on additional saving is less.
		- The process of real income rising is part of the market's equilibration toward the new time preference structure.
	- The higher real incomes are not a cause of further saving—they are the result of the earlier shift in time preference and the accompanying drop in the interest rate. The real income gains are met with, or rather made possible by, the lower interest rate.
		- This is why no further shift in saving behavior occurs, unless there’s another change in time preferences.
			- Do not take the effect for the cause.
	- **Higher real incomes don’t cause more saving—they are the reward of it**.
		- The market economy rewards abstinence, but it does not trick you into abstaining again.
		- Put simply, **saving only increases in the aggregate when the underlying time preferences in the economy shift.**
			- **Interest rates adjust immediately to reflect this shift, preventing recursive saving loops**.
	- **Both the fall in interest rates and the eventual rise in real incomes are consequences of a common cause: a lowering of time preference. The former is immediate and prevents the latter from instigating further saving, ensuring the process does not loop. Both effects are coordinated reflections of the same underlying shift in intertemporal valuation.**
		- This is a textbook example of the elegance of the market process — and how price signals (here, the interest rate) act as self-correcting mechanisms within the system of supply and demand. #develop 
			- E.g., see [[Eric Voskuil]]’s [Stability Principle]
- After the effect of saving plays out, higher stage production processes will benefit both nominally and in real terms, while lower stages’ profit in real terms are offset by nominal loss (due to the reduction in consumption). However, there must be an intermediary production processes who benefit solely in real terms.
	- In the ERE that follows a progressing phase, only the intermediary factor owners see unambiguous real gains without transitional distortion. The higher stages gain via temporary profit (which disappears), and the lower stages face nominal losses that may or may not be offset by falling prices. Thus, the cleanest expression of progress in Rothbard’s analysis—as separated from profit and loss—is found in the middle stages of production.
		- **In Rothbard’s capital theory, the clearest beneficiaries of economic progress are factor owners in the intermediary stages of production, who experience no nominal disruption but gain in real terms due to increased purchasing power**. These gains are structurally distinct from entrepreneurial profit and unaffected by transitional losses at other stages.
...
- But by what process does the market isolate and determine the share (the MVP of a certain unit of a factor) of income yielded from production? (p. 458) #revisit 
