...
- Michael Green on BTC and my inspired memos:
	...
	- China mining concentration have way to US, now US concentration giving way to Africa ([[2-2d Gresham’s Law generalized—the bad practice drives out the good |Gresham’s law]])
...
- **On [[Ludwig von Mises |Mises]]’ tautology** (that had the gold not been produced, prices would be unchanged):
...
- On commodity money (i.e., gold—not bitcoin):
	...
	- Therefore, independent of demand, the money relation is controlled by the rate of change in necessary production factors. Such changes are presumed to be unpredictable, as otherwise they are already incorporated into price. (p. 197) #revisit 
		- Price is by definition unpredictable. #develop 
			- Related: [[5-1b1a2d Knowledge is by definition unpredictable]]. #develop 
## Labor and Leisure 
