E.g., if no limitation, no zk-SNARKs

Related:
- Constraints and limitations can be powerful—after all there is no constraints and limitations in nature—it just so appears that way *to us*
