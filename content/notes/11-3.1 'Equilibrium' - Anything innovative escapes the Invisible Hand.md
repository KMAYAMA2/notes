Politics and evolution are inherently zero-sum because both are about adaptation to the existing environment (i.e., indexical). But humans are creative because we can virtually render and tweak the representation of such environment with symbols, and can turn these games into positive-sum—evolutionary pressure will be always there but the game keeps changing much faster and voluntarily with humans. #develop 
