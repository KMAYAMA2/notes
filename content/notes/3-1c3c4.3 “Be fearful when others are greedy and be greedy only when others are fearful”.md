...
It’s probably all about fear, because greed is essentially about FOMO (fear-of-missing-out). #revisit 

Previous:
- [[3-1c3c4.2 “Whenever you find yourself on the side of the majority, it is time to pause and reflect”]]
	- Remember year-end 築地市場—higher price (and the quality might be lower)
...
- Things are often cheapest when people are fearful and pessimistic (I think the lesson here applies not only to investment but life in general) #develop 
...
- [[2-1e Everything is connected in a complex way]]
	- Fear spreads [[1-2i Brandolini’s Law (the Bullshit Asymmetry Principle)—the amount of energy needed to refute bullshit is an order of magnitude bigger than that needed to produce it |easily]] during [[5-1b3a In particular, we underestimate how much we can change in the future during and after downturns. Things change. |downturn]]
