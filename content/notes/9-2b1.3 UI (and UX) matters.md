...
- Uniswap protocol and UI control 60% of DeFi market (?) #develop
	- But with the advent of NEAR Intents, Uniswap will be the infra, despite the former’s higher fees
		- [[8-1e You have to go beyond skeuomorphism. Native means novelty.]] #develop 
		- [[8-2b2b Key moment is when people (e.g., devs) don't have to worry about the infrastructure (e.g., platform risks including high take rates)]] #develop 