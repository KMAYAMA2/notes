...
- know your time horizon—how can you be focused on the long-run when you are looking for entry point in the short-run? #revisit 
	- → upon reflecting, this is on false premise—==**time doesn’t exist objectively, and in edge case money acts as measure (remember Ayache)—this is why knowing target price (derived via target share) can be more important than knowing your time horizon**== (20260104) <> 5-1b4 #challenge 
		- <> measuring it with
